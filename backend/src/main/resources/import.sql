...
#bug-mysqlworkbench ( insere de com AUTO_INCREMENT de 5 em 5 ? sem motivo conhecido ate o momento...)
UPDATE tb_sellers SET id = 1 WHERE id = 5;
UPDATE tb_sellers SET id = 2 WHERE id = 15;
UPDATE tb_sellers SET id = 3 WHERE id = 25;
UPDATE tb_sellers SET id = 4 WHERE id = 35;
UPDATE tb_sellers SET id = 5 WHERE id = 45;
